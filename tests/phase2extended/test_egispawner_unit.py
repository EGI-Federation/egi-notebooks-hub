...
# phase2-19
# Component: EGISpawner.configure_secret_volumes
# Purpose: Ensure the method works whether volume_mounts / volumes are stored as dicts
# or
...
# phase2-25
# Component: EGISpawner._profile_filter
# Purpose: Ensure that missing profile configuration simply yields no choices rather
# than
